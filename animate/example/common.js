/* Перемещаем элемент с помощью стрелок на клавиатуре */
...
//   if (this.classList.contains('column--hover')) return
//   this.classList.add('column--hover')
//   let columnNumber = 75
//   const columnNumberInterval = setInterval(() => {
//     this.innerHTML = `${columnNumber}%`
//     if (columnNumber === 100) clearInterval(columnNumberInterval)
//     columnNumber++
//   }, 29);
// })
